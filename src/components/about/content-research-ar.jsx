  ...
  return (
    <div className="content">
      <div className="item">
        ...
        <p className="text">
        تخدم مكتبات جامعة بنسلفانيا أعضاء هيئات التدريس ذوي المكانة العالمية والطلاب في كلياتها الاثنتي عشرة. تتضمن مجموعاتها أكثر من 7 ملايين مجلد وأكثر من 100,000 مجلة وحوالي مليوني صورة رقمية بالإضافة إلى مواد جد نادرة وفريدة توثق الخبرة الفكرية والثقافية للحضارات القديمة والحديثة. من خلال علاقاتنا التعاونية ندعم المجموعات المحلية الرائعة للجامعة بالنفاذ المادي إلى مركز
