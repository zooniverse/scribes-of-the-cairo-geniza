...
اليوم تلعب المكتبات دوراً أساسياً في تطوير التكنولوجيات الحديثة لكشف المعلومة ونشرها وهي معروفة بعملها الرائد في التصميم الرقمي. لمعرفة المزيد عن مكتبات جامعة بنسلفانيا، قم بزيارة:
      ...
      <div className="item">
        ...
        <p className="text">
          مختبر ليجا الإلكتروني (e-Lijah) ومركز البحوث متعددة الإختصاصات في جنيزا القاهرة بجامعة حيفا
e-Lijah (التعلم الإلكتروني في مجال الدراسات اليهودية بحيفا) هو مختبر إلكتروني للعلوم الإنسانية يهدف إلى تطوير وتنفيذ العلوم المواطنية ومشاريع حشد المصادر في العلوم الإنسانية. يغطي المختبر الفترة الزمنية الممتدة من العصور القديمة إلى العصر الحديث ويشتمل على وسائل واختصاصات متنوعة تشمل المصادر التاريخية والمكانية والنصية والأدبية والبصرية. يتبع المختبر نموذج ثلاثي العناصر للعلوم المواطنية. كل مشروع في المختبر ملتزم بتطوير منصة إلكترونية وإنشاء نشاط تربوي أو غيره من الأنشطة العامة لضمان تواجد حيوي لمجموعة من المتبرعين ولإنجاز بحوث انطلاقا من المساهمات العامة للجمهور.
        </p>
        <p className="text">
