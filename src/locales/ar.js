export default {
  ...
  specialThanks: {
    main: `
      بالإضافة إلى ذلك، نوجه شكرا وامتنانا خاصا للدكتورة جين باور وهال بلاكبورن والطيب الشريف وجسيكا
      دومر وتيموثي دانغيت وسكوت إندرلي والدكتورة جيسيكا غولدبرغ وربيكا هيل وامي هاتشينز والدكتور
      ديفيد كريمر والدكتورة نيتا كريفانس وكتي لينش وغاياتري ب. أوروغانتي والدكتور بن أوثوايت والدكتور
      كريغ بيري وبصان رضوان والدكتورة سيناي روزينك وياسمين شينوهارا والدكتورة سمدار شتول وإيما
      .ستانفورد والدكتور أوديد زينغر لمساهماتهم
    `,
    additional: `
