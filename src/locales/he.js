export default {
  ...
  bios: {
    ...
    Samantha: {
      ...
      description: 'סמנתה בליקהן היא פוסט דוקטורנטית בזוניברס, המפתחת פרקטיקות מיטביות לתעתוק המונים.'
    },
    Laura: {
      name: 'Laura Newman Eckstein',
      description: 'לורה ניומן-אקשטיין שימשה כרכזת מדעי היהדות הדיגיטליים בספריות אוניברסיטת פנסילבניה (2016-2018).'
    },
    Doug: {
      name: 'Doug Emery',
      description: `
        דאג אמרי הוא מתכנת תוכן דיגיטלי במרכז קיסלק לאוספים מיוחדים, ספרים נדירים וכתבי יד באוניברסיטת פנסילבניה.
      `
    },
    Mitch: {
      name: 'Mitch Fraas',
      description: `
        מיץ' פראס הוא אוצר האוספים המיוחדים במרכז קיסלק לאוספים מיוחדים, ספרים נדירים וכתבי יד באוניברסיטת פנסילבניה.
      `
    },
    WillGranger: {
      name: 'Will Granger',
    ...
    Arthur: {
      name: 'Arthur Kiron',
      description: `
        ארתור קירון הוא אוצר אוספי היודאיקה ע"ש שוטנשטיין-יסלזון, ראש הספריה למחקרי יהדות מתקדמים במרכז הרברט ד. כץ בפנסילבניה, ומרצה להיסטוריה באוניברסיטת פנסילבניה.
      `
    },
    Moshe: {
      name: 'Moshe Lavee',
      description: `
        משה לביא עומד בראש מעבדת אליהו לשיתוף המונים במדעי היהדות, ראש התכנית למדעי הרוח הדיגיטליים וממנהלי המרכז לחקר הגניזה באוניברסיטת חיפה. מרצה לתלמוד ומדרש בחוג לתולדות ישראל, מחשבת ישראל ומקרא באוניברסיטת חיפה, ומתמחה בחקר המדרש בגניזה.
      `
    },
    Eve: {
      name: 'Eve Krakowski',
    ...
    William: {
      name: 'William Noel',
      description: `
        ויליאם נואל הוא ראש מרכז קיסלק לאוספים מיוחדים, ספרים נדירים וכתבי יד, וראש מכון שונברג לחקר כתבי יד באוניברסיטת פנסילבניה.
      `
    },
    Shaun: {
    ...
    Vered: {
      ...
      description: `
        ורד רזיאל קרצ'מר היא פוסט-דוקטורנטית במעבדת אליהו לשיתוף המונים במדעי היהדות באוניברסיטת חיפה, אחראית על פרויקט שיתוף המונים בגניזת קהיר, ומתמחה בחקר התפילה מן הגניזה.
      `
    },
    Raha: {
      name: 'Raha Rafii',
    ...
    Becky: {
      name: 'Becky Rother',
      description: `
        בקי רות'ר היא המעצבת של זוניברס, מעצבת את סביבת העבודה באתר ליצירת חוויית תעתוק מיטבית.
      `
    },
    Marina: {
      name: 'Marina Rustow',
      description: `
        מרינה רוסטוב עומדת בראש קתדרת כדורי א. זילכה לתרבות יהודית במזרח הקרוב, פרופסור לחקר ההיסטוריה של המזרח הקרוב באוניברסיטת פרינסטון ומתמחה בגניזה הדוקומנטרית.
      `
    },
    Emily: {
      name: 'Emily Esten',
  ...
  specialThanks: {
    main: `
      תודתנו שלוחה לד"ר ג'ין באואר, אליזבת' בייטס, האל בלקברן, טייב שריף, ג'סיקה דאמר, טימות'י דנגייט, סקוט אנדרל, ד"ר ג'סיקה גולדברג, רבקה היל, אמיי האצ'ינס, ד"ר דוד קרמר, ד"ר ניטה קרוונס, קייט לינץ', גייטרי ב. אורוגנטי, ד"ר בן אות'וויט, ד"ר קרייג פרי, בסאן רדוואן, ד"ר סיני רוסינק, ד"ר ג'ודית אולשובי-שלאנגר, ג'סמין שינוהרה, ד"ר סמדר שטהל, אמה סטנפורד, עינת טמיר וד"ר עודד זינגר על תרומתם לפרויקט.
    `,
    additional: `
      תודה למוסדות הבאים שתרמו סריקות נוספות לפרויקט: ספריית המדינה בברלין, הספריה הבריטית בלונדון, הספריה הלאומית בירושלים
    `
  },
  textModifiers: {
    insertion: 'תוספת',
  ...
  transcribeHebrew: {
    ...
    content: `
      העתיקו קטעי גניזה הכתובים באותיות עבריות. בחרו בין העתקה של קטעים הכתובים בכתב פורמלי (משימה קלה יותר ומתאימה למתחילים) ובין העתקה של קטעים הכתובים בסגנון בלתי פורמלי (משימה מאתגרת יותר)
    `,
  ...
  transcribeArabic: {
    ...
    content: `
      העתיקו קטעי גניזה הכתובים באותיות ערביות. בחרו בין העתקה של קטעים הכתובים בכתב פורמלי (משימה קלה יותר ומתאימה למתחילים) ובין העתקה של קטעים הכתובים בסגנון בלתי פורמלי (משימה מאתגרת יותר)
    `,
    exercises: 'תרגול העתקה מלאה',
  ...
  keywordsHebrew: {
    ...
    content: `
      עזרו לנו לאתר מילות מפתח בקטעים הכתובים עברית או ערבית-יהודית. איתור מילות המפתח הוא אמצעי לזיהוי קטעים העשויים להיות מאתגרים יותר לקריאה. במקום לנסות לתעתק את המסמך כולו, אתרו בו ביטויים ומילים שיעזרו לנו להתחיל את התהליך
    `,
  ...
  keywordsArabic: {
    ...
    content: `
      עזרו לנו לאתר מילות מפתח בקטעים הכתובים ערבית. איתור מילות המפתח הוא אמצעי לזיהוי קטעים העשויים להיות מאתגרים יותר לקריאה. במקום לנסות לתעתק את המסמך כולו, אתרו בו ביטויים ומילים שיעזרו לנו להתחיל את התהליך
    `,
  ...
  home: {
    ...
    aboutResearch: 'שותפי המחקר',
    aboutScribes: 'אודות סופרי הגניה הקהירית',
  ...
  landingPage: {
    ...
    paragraphTwo: {
      ...
      chunkFive: 'שיעזרו לפענח את הקטעים הקשים יותר.'
    },
    paragraphThree: `
